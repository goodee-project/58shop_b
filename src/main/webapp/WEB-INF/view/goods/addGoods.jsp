		...
		<div class="container-fluid">
			<div class="box_general padding_bottom">
				<div class="header_box version_2">
					<h2><i class="fa fa-file"></i>상품 추가</h2>
				</div>
				...
				<div>
					<form enctype="multipart/form-data" action="${pageContext.request.contextPath}/goods/addGoods" method="post" id="addForm">
						...
						<div class="row">
							<div class="col-md-2">
								<label class="fix_spacing">* 카테고리</label>
							</div>
							<div class="col-md-5">
						...
						<div class="row">
							<div class="col-md-2">
								<label class="fix_spacing">활성화 상태</label>
							</div>
							<div class="col-md-5">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-md-2">
								<label class="fix_spacing">상품 이미지 등록</label>
							</div>
							<div class="col-md-5">
								<div class="form-group">
									<input type="file" class="form-control dropzone" name="goodsImg"/>
								</div>
							</div>
						</div>
